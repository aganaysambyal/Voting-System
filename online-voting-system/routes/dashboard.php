                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                if($_SESSION['status']==1){
                                    ?>
                                    <button disabled style="padding: 5px; font-size: 15px; background-color: #ffbf00; color: black ; border-radius: 5px;" type="button">Voted</button>
                                    <?php
                                }
                                else{
                                    ?>
                                    <button style="padding: 5px; font-size: 15px; background-color: #ffbf00 color: black; border-radius: 5px;" type="submit">Vote</button>
                                    <?php
                                }
                                ?>
                                </form>
