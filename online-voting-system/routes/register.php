<html>
    <head>
        <title>voting system - Registratrion</title>
        <link rel="stylesheet" href="C:\xampp\htdocs\projects\online-voting-system\stylesheet.css">
        <style>
            body {
        ...
        <center>
            ...
            <h2>Registration</h2>
                <form action="../api/register.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="number" name="mob" placeholder="Mobile number" required><br><br>
